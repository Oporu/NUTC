...
function rickroll(){
	for (i=0;i<tds.length;i++){
		if (i!=4)
			tds[i].innerHTML = "<iframe width='99.66' height='65' src='https://www.youtube.com/embed/dQw4w9WgXcQ?autoplay=1;rel=0&amp;showinfo=0' frameborder='0' allowfullscreen allow='autoplay'></iframe>"
	}
